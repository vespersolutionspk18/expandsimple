...
const LogoTestInverted: React.FC = () => {
  ...
  // Color scheme optimized for green footer background (#1d4ed8)
  const borderColor = '#1e40af'  // Darker green for depth and borders
  const edgeColor = '#93c5fd'     // Light green for strong contrast against footer green
  const vertexFill = 'white'      // White for maximum visibility
  const vertexStroke = '#1e40af'  // Darker green to tie with borders
