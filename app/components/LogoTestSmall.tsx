...
const LogoTestSmall: React.FC = () => {
  ...
  // Scaled down cube - about 60% of original size
  const cubeSize = 14.976  // 24.96 * 0.6
  const svgSize = 39.312   // 65.52 * 0.6
  const centerX = 19.656   // 32.76 * 0.6
  const centerY = 19.656   // 32.76 * 0.6

  // Scaled down styling
  const edgeWidth = 2.34   // 3.9 * 0.6
  const sphereRadius = 2.73  // 4.55 * 0.6
  const sphereBorder = 0.702  // 1.17 * 0.6
    ...
    >
      ...
      >
        <g id="cube-container">
          ...
          <g id="edges">
            <line id="edge-bottom-front" stroke="#1d4ed8" strokeWidth={edgeWidth} strokeLinecap="round" x1={vertices.bottomFrontLeft.x} y1={vertices.bottomFrontLeft.y} x2={vertices.bottomFrontRight.x} y2={vertices.bottomFrontRight.y} />
            <line id="edge-bottom-right" stroke="#1d4ed8" strokeWidth={edgeWidth} strokeLinecap="round" x1={vertices.bottomFrontRight.x} y1={vertices.bottomFrontRight.y} x2={vertices.bottomBackRight.x} y2={vertices.bottomBackRight.y} />
            <line id="edge-bottom-back" stroke="#1d4ed8" strokeWidth={edgeWidth} strokeLinecap="round" x1={vertices.bottomBackRight.x} y1={vertices.bottomBackRight.y} x2={vertices.bottomBackLeft.x} y2={vertices.bottomBackLeft.y} />
            <line id="edge-bottom-left" stroke="#1d4ed8" strokeWidth={edgeWidth} strokeLinecap="round" x1={vertices.bottomBackLeft.x} y1={vertices.bottomBackLeft.y} x2={vertices.bottomFrontLeft.x} y2={vertices.bottomFrontLeft.y} />
            <line id="edge-vertical-front-left" stroke="#1d4ed8" strokeWidth={edgeWidth} strokeLinecap="round" x1={vertices.bottomFrontLeft.x} y1={vertices.bottomFrontLeft.y} x2={vertices.topFrontLeft.x} y2={vertices.topFrontLeft.y} />
            <line id="edge-vertical-front-right" stroke="#1d4ed8" strokeWidth={edgeWidth} strokeLinecap="round" x1={vertices.bottomFrontRight.x} y1={vertices.bottomFrontRight.y} x2={vertices.topFrontRight.x} y2={vertices.topFrontRight.y} />
            <line id="edge-vertical-back-left" stroke="#1d4ed8" strokeWidth={edgeWidth} strokeLinecap="round" x1={vertices.bottomBackLeft.x} y1={vertices.bottomBackLeft.y} x2={vertices.topBackLeft.x} y2={vertices.topBackLeft.y} />
            <line id="edge-vertical-back-right" stroke="#1d4ed8" strokeWidth={edgeWidth} strokeLinecap="round" x1={vertices.bottomBackRight.x} y1={vertices.bottomBackRight.y} x2={vertices.topBackRight.x} y2={vertices.topBackRight.y} />
            <line id="edge-top-front" stroke="#1d4ed8" strokeWidth={edgeWidth} strokeLinecap="round" x1={vertices.topFrontLeft.x} y1={vertices.topFrontLeft.y} x2={vertices.topFrontRight.x} y2={vertices.topFrontRight.y} />
            <line id="edge-top-right" stroke="#1d4ed8" strokeWidth={edgeWidth} strokeLinecap="round" x1={vertices.topFrontRight.x} y1={vertices.topFrontRight.y} x2={vertices.topBackRight.x} y2={vertices.topBackRight.y} />
            <line id="edge-top-back" stroke="#1d4ed8" strokeWidth={edgeWidth} strokeLinecap="round" x1={vertices.topBackRight.x} y1={vertices.topBackRight.y} x2={vertices.topBackLeft.x} y2={vertices.topBackLeft.y} />
            <line id="edge-top-left" stroke="#1d4ed8" strokeWidth={edgeWidth} strokeLinecap="round" x1={vertices.topBackLeft.x} y1={vertices.topBackLeft.y} x2={vertices.topFrontLeft.x} y2={vertices.topFrontLeft.y} />
          </g>
