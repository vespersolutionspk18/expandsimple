...
const WhyLatticeCRM = ({ cards }: WhyLatticeProps) => {
  return (
    <div className="py-16 px-10 bg-white">
      {/* SVG Gradient Definition */}
      <svg width="0" height="0" style={{ position: 'absolute' }}>
        <defs>
          <linearGradient id="green-gradient-why-crm" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-3 gap-8">
            {cards.map((card, index) => (
              ...
              >
                ...
                <div className="relative p-[3px] rounded-2xl animated-gradient-crm shadow-xl hover:shadow-2xl transition-shadow duration-300">
                  {/* Card content */}
                  <div className="bg-white rounded-2xl p-8 h-[500px] flex flex-col items-center">
                    ...
                    <div className="mb-6">
                      <card.icon
                        size={48}
                        strokeWidth={1.5}
                        style={{ stroke: 'url(#green-gradient-why-crm)' }}
                      />
                    </div>
        ...
        <div className="flex justify-center">
          <button className="group flex items-center gap-2 px-8 py-3 text-white rounded-full font-medium hover:shadow-lg transition-shadow duration-300"
            style={{
              background: 'linear-gradient(to right, #22c55e 0%, #166534 20%, #166534 80%, #22c55e 100%)'
            }}>
