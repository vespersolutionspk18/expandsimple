 ...
 <div className="p-5">
      ...
      <div className="flex flex-row gap-16">
          ...
          <p className="text-black/75 text-2xl tracking-tighter w-[68%]">
            See how Expand transforms contractors&apos; businesses. From stunning 3D visualizations to complete digital transformations, these success stories showcase the power of our integrated B2B solutions for home remodeling professionals.
          </p>
        </div>
