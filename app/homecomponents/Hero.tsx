...
const Hero = ({
  preHeader,
  headline = "Marketing That Fills Your Pipeline with High-Value Remodeling Projects",
  subtitle = "The only full-service digital marketing agency built exclusively for home service businesses. From SEO to PPC, web design to AI consultancy we fill your schedule with qualified leads.",
  backgroundStyle,
  height = "760px",
  showARVRBanner = true,
  showForm = true,
      ...
      >
        ...
        <div className={`${showForm ? 'w-full lg:w-1/2' : 'w-full'} h-full p-4 sm:p-5 md:p-6 lg:p-5 flex flex-col justify-center relative z-10`}>
          <div className={`p-2 sm:p-4 md:p-5 flex flex-col gap-4 sm:gap-5 md:gap-7 ${showForm ? 'items-start text-left' : 'items-center text-center'}`}>
            {/* AIEO Announcement Banner or Pre-header */}
            {showARVRBanner && (
              <Link href="/services/aieo">
                <div className="inline-flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-1.5 sm:py-2 w-fit cursor-pointer hover:scale-105 transition-transform duration-200 border border-gray-300 rounded-full bg-gray-50">
                  ...
                  <span className="text-gray-900 text-xs sm:text-sm font-medium tracking-tight flex items-center gap-1 sm:gap-2">
                    <span className="hidden sm:inline">AI Engine Optimization (AIEO) - Be the First Recommendation</span>
                    <span className="sm:hidden">AIEO Now Available</span>
          ...
          <div className="w-full lg:w-1/2 h-full p-4 sm:p-5 md:p-6 lg:p-5 flex items-center justify-center relative z-10">
            <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 w-full max-w-md shadow-2xl">
              ...
              <p className="text-gray-600 mb-6 sm:mb-8 text-sm sm:text-base leading-relaxed">
                Discover how to dominate your local market and win more high-ticket projects. Book a free strategy session with our experts.
              </p>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-2 sm:gap-3">
                <input
                  ...
                  className="w-full px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg sm:rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#1d4ed8] focus:border-transparent text-gray-900 placeholder-gray-400 text-sm sm:text-base"
                  required
                />
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={2}
                  className="w-full px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg sm:rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#1d4ed8] focus:border-transparent text-gray-900 placeholder-gray-400 resize-none text-sm sm:text-base"
                  required
                />
