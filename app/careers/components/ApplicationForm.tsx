    ...
    <div id="application-form" className="p-5">
        ...
        <div className="relative z-10 flex flex-col h-full justify-between">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-4">
              <div>
                <h3 className="text-white text-2xl tracking-tighter mb-2">Why work at Expand?</h3>
                <ul className="text-white/90 text-base tracking-tight space-y-2">
                  ...
                  <li>• Professional development & certification budget</li>
                  <li>• Unlimited PTO policy</li>
                  <li>• Work with 500+ home service businesses</li>
                </ul>
              </div>
            </div>
            <div>
      ...
      <div className="w-[55%] p-8 bg-white">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-black/85 text-sm mb-1 tracking-tight">
              Why do you want to work at Expand? <span className="text-red-500">*</span>
            </label>
            <textarea
              name="coverLetter"
